...
export default function TreeMenu() {
  ...
  return (
    <div className="main-tree">
      {/* className={hide ? 'mid-sec-wrap' : 'mid-sec-wrap1'}  */}
     {
      !hide &&(
    ...
    {
        hide ?(
          <button  onClick={()=>ShowHide(!setHide)}><KeyboardDoubleArrowLeftIcon className="lefticon"/></button>
        ):<button  onClick={()=>ShowHide(!setHide)}><KeyboardDoubleArrowRightIcon className="righticon lefticon "/></button>
      }
    </div>
  );
}
