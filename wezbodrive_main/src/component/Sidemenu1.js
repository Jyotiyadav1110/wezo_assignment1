...
import Logo_removebg from './icons/full-logo.png'
...
export default function LeftDashboard() {
  return (
    <div className="left-section-wrapper">
      ...
      <img src={Logo_removebg} className="logo-image" />
      <div className="profile">
        <img 
        src="https://images.pexels.com/photos/220453/pexels-photo-220453.jpeg" className="profile-image" />
